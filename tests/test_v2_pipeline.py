...
test_args = [
    # (input_file, raw_data)  # (name of input file with no path, path to folder or test folder acting as raw data source)
    ("test_input_1.csv", "./tests/assets/"),
    ("test_input_2.csv", "./tests/assets/"),
]
